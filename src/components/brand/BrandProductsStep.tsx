...
/** Category filter for the imported catalog. */
const FILTERS = ["All", "Tops", "Bottoms", "Outerwear", "Accessories", "Jewelry", "Other"] as const;
type FilterId = (typeof FILTERS)[number];

function classifyImported(title: string, rawType: string): { filter: FilterId; base: ProductProfileType; productType: string } {
